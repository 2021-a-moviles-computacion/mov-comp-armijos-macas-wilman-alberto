...
class Desarrollador(
    private var idDesarrollador: Int?=null,
    ...
    public fun getIdDesarrollador(): Int? {
    ...
    public fun setIdDesarrollador(idDesarrollador: Int?) {
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        parcel.writeValue(idDesarrollador)
